  ...
  template: `
    <div class="mb-6">
      <div class="flex items-center gap-3 mb-1">
        <span class="module-badge module-badge--blue">8.</span>
        <h1 class="text-2xl font-extrabold text-[#071938]">Pedidos</h1>
      </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mb-6">
      <div class="relative flex-1 max-w-xl">
        ...
        <input
          ...
          (ngModelChange)="orderService.setSearchTerm($event)"
        ...
        @if (totalPages() > 1) {
          <div class="fm-pagination border-t border-gray-100">
            ...
            @for (page of visiblePages(); track page) {
              @if (page === -1) { <span class="px-1 text-gray-400">...</span> }
              @else {
